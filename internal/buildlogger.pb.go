...
// source: vendor/buildlogger.proto
...
func (LogStorage) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cfc2d4ce21b3c74d, []int{0}
}
...
func (LogFormat) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cfc2d4ce21b3c74d, []int{1}
}
...
func (*LogLines) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfc2d4ce21b3c74d, []int{2}
}
...
func (*LogLine) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfc2d4ce21b3c74d, []int{3}
}
...
func (*LogEndInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfc2d4ce21b3c74d, []int{4}
}
...
func (*BuildloggerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfc2d4ce21b3c74d, []int{5}
}
...
func init() { proto.RegisterFile("vendor/buildlogger.proto", fileDescriptor_cfc2d4ce21b3c74d) }

var fileDescriptor_cfc2d4ce21b3c74d = []byte{
	...
	,
}
...
var _Buildlogger_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "vendor/buildlogger.proto",
}
